...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const customServiceAgreement(),
    );
  }
}
...
class customServiceAgreement extends StatefulWidget {
  const customServiceAgreement({super.key});




  @override
  State<customServiceAgreement> createState() => _customServiceAgreementState();
}




class _customServiceAgreementState extends State<customServiceAgreement> {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              const Text('소복소복 소비자 약관 동의', style: TextStyle(fontSize: 22.0, fontWeight: FontWeight.w700)),
                  ...
                  Expanded(
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => ConsumerNickname()),
                        );
                      },
