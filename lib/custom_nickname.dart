...
import 'custom_blackwhite.dart';

class ConsumerNickname extends StatefulWidget {
  @override
  State<ConsumerNickname> createState() => _ConsumerNicknameState();
}

class _ConsumerNicknameState extends State<ConsumerNickname> {
  ...
  void _submitData() async {
    ...
    await FirebaseFirestore.instance.collection('consumers').doc(nickname).set({
