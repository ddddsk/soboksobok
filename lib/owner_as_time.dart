...
class _AvailableTimeSelectionScreenState extends State<AvailableTimeSelectionScreen> {
  ...
  void _submitData() async {
    await FirebaseFirestore.instance.collection('owners').doc(widget.nickname).update({
      'morning_as': morningSelected ? '12시 이전' : '',
      'afternoon_as': afternoonSelected ? '12시~18시' : '',
      'evening_as': eveningSelected ? '18시 이후' : '',
